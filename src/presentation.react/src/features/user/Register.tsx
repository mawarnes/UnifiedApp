...
export const Register = () => {
    ...
    const onFinish = async (values: FieldType) => {
        ...
        if (data?.isSucceed) {
            ...
            data.messages?.DuplicateUserName && formRef.current?.setFields([{ name: "email", errors: data.messages?.DuplicateUserName },]);
            data.messages?.password && formRef.current?.setFields([{ name: "password", errors: data.messages?.password },]);
        }
        else {
        ...
        <>
            ...
            >
                ...
                <Form.Item<FieldType>
                    ...
                    extra={
                        <ul>
                            <li>Minimum Length: The password must be at least 6 characters long.</li>
                            <li>At least 1 Uppercase Letter: Include at least one uppercase letter (A-Z).</li>
                            <li>
